...
{				
 ...
 abline(h=0.902/(1-0.902),lty=2,lwd=2,col="red")
...
b<-read.table("/Users/wuzhongzi/Desktop/pp_HL.txt",header=T)
...
#dev.off()
pdf("/Users/wuzhongzi/Desktop/ppSS.fst.pdf",height=5,width=16)
par(mai=c(1,1.2,0.5,0.3))
manhattanPlot(dat=plotb,trait="logp")
dev.off()
