...
all=(`cat pb35.txt2 | cut -f 1`)
PBS_ARRAYID=${SLURM_ARRAY_TASK_ID}
sample=${all[$PBS_ARRAYID]}

dep=(`cat pb35.txt2 | cut -f 3`)
cov=${dep[$PBS_ARRAYID]}

singularity exec -B /home/sgtpyangb/AllFlash/wzz_tmp/30.T2T_DRC/01.DRC/01.SV/02.T2T_sus:/myref -B /home/sgtpyangb/wzz_STR_tmp/tmpSV2486/90.TGS:/home/sgtpyangb/wzz_STR_tmp/tmpSV2486/90.TGS /home/guilu/software/174.cute.sif cuteSV /home/sgtpyangb/wzz_STR_tmp/tmpSV2486/90.TGS/02_PB/${sample}_*.bam /myref/sus11.fa csv_Pb_${sample} /home/sgtpyangb/wzz_STR_tmp/tmpSV2486/90.TGS/cc_${sample} --genotype --max_cluster_bias_INS 100 \
